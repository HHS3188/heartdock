...
v0.7.0 是个性化场景、动态显示与心率记录版本，在 v0.6.0 纯享体验和配置文件增强基础上，继续完善常用场景预设、显示框样式、心率动态效果和纯享记录导出能力：
...
开启“记录纯享心率”后，进入纯享模式会自动开始记录有效 BPM，退出纯享模式时显示本次报告。报告包含记录时长、平均心率、最高 / 最低心率、有效样本、心率波动、区间分布和时间线，并可导出为 PNG 图片。
